...
export default function Product() {
  ...
  const COLORS = ['#93C5FD', '#A7F3D0', '#FDE68A', '#FECACA']
            ...
            <div className='text-black bg-gray-100 border-2 p-4 mt-8 rounded-lg shadow-md text-center'>
              ...
              <ResponsiveContainer width='100%' height={400}>
                ...
                >
                  ...
                  />
                  <Bar dataKey='A' fill='#93C5FD' barSize={20} />
                </BarChart>
              </ResponsiveContainer>
            </div>
            <div className='text-black bg-gray-100 border-2 p-4 mt-8 rounded-lg shadow-md text-center'>
              ...
              <ResponsiveContainer width='100%' height={400}>
                ...
                >
                  ...
                  />
                  <Bar dataKey='A' fill='#A7F3D0' barSize={20} />
                </BarChart>
              </ResponsiveContainer>
            </div>
            <div className='text-black bg-gray-100 border-2 p-4 mt-8 rounded-lg shadow-md text-center'>
              ...
              <ResponsiveContainer width='100%' height={400}>
                ...
                >
                  ...
                  />
                  <Bar dataKey='A' fill='#FDE68A' barSize={20} />
                </BarChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className='text-black bg-gray-100 border-2 p-4 mt-8 rounded-lg shadow-md text-center'>
              ...
              <ResponsiveContainer width='100%' height={400}>
                ...
                >
                  ...
                  />
                  <Bar dataKey='A' fill='#FECACA' barSize={20} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
